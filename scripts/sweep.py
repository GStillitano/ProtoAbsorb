...
def main():
    ...
    for corruption, alpha, csood_source, seed in product(corruptions, alphas, csood_sources, seeds):
        if csood_source == "rome32":
            print(f"Skipping rome32 (not yet available): {corruption} α={alpha} seed={seed}")
            continue
